                          ...
                          <tr>
                           ...
                           <td align="center">
                              <div class="hidden-sm hidden-xs action-buttons">
                                      <a class="blue" href="<?php echo base_url();?>user/detail/<?php echo $row->id_user?>" id="show-option3" title="Detail"  class="tooltip-info" data-rel="tooltip" >
                                        <i class="fa fa-search-plus bigger-130"  ></i>
                                      </a>

                                      <a class="green" href="<?php echo base_url();?>user/ubah/<?php echo $row->id_user?>" id="show-option2" title="Edit" class="tooltip-info" data-rel="tooltip">
                                        <i class="fa fa-pencil bigger-130" ></i>
                                      </a>

                                      <a class="red" href="<?php echo base_url();?>user/delete/<?php echo $row->id_user?>"
