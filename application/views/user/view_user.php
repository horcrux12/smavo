            ...
            ?>
              ...
              <td class="center">
                <div class="hidden-sm hidden-xs action-buttons">
                  ...
                  <a class="tooltip-info red" href="<?php echo base_url(); ?>admin/administrator/hapus-administrator/<?php echo $row->id_user ?>" title="Hapus" data-rel="tooltip" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
