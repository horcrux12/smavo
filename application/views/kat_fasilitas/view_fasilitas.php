...
<div class="row">
                  <div class="col-xs-12">
                    ...
                    <div class="clearfix">
                      ...
                      <a href="<?php echo base_url();?>admin/kategori-fasilitas/tambah-fasilitas" class="btn btn-primary btn-small">
                        ...
                        <tbody>
                            ...
                            <td class="center" > 
                                <div class="hidden-sm hidden-xs action-buttons">
                                      <a class="tooltip-info blue" href="<?php echo base_url();?>admin/kategori-fasilitas/detail-fasilitas/<?php echo $row->id?>" title="Detail" data-rel="tooltip" >
                           ...
                           <td class="center">
                                      ...
                                      <a class="tooltip-info red" href="<?php echo base_url();?>admin/kategori-fasilitas/hapus-fasilitas/<?php echo $row->id?>"
