...
<!-- END CEK FORM KOSONG -->
    ...
    <!-- Kembali -->
      ...
      <!-- end kembali -->
           ...
           <form class="form-horizontal style-form" style="margin-top: 20px;" method="POST" enctype="multipart/form-data" name="form1" id="form1" action="<?php echo base_url();?>kat_artikel/simpan" onsubmit="return cekform();">
