...
<script type="text/javascript">
  ...
  function cekform(){
      ...
      if(!$ ("#kode").val())
      {
        alert('Maaf ID kategori profil tidak boleh kosong');
        $("#kode").focus();
        return false;
      ...
      if(!$ ("#nama").val())
      {
        alert('Maaf nama kategori profil tidak boleh kosong');
        $("#nama").focus();
        return false;
    ...
    <!-- Kembali -->
      ...
      <!-- end kembali -->
           ...
           <form class="form-horizontal style-form" style="margin-top: 20px;" method="POST" enctype="multipart/form-data" name="form1" id="form1" action="<?php echo base_url();?>kat_profil/simpan" onsubmit="return cekform();">
              ...
              <div class="form-group">
              <label for="" class="col-sm-2 control-label">Nama Kategori profil</label>
              <div class="col-sm-5">
              <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Kategori profil">
              </div>
              </div>
