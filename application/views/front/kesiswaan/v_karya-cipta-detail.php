                                    ...
                                    <div class="post-meta">
                                        ...
                                        <ul class="meta">
                                            <li>
                                                ...
                                                <a href=""><i class="fa fa-user" aria-hidden="true">&nbsp;</i><?php echo $nama_user; ?></a></li>
                                            <li>
                                                <a href=""><i class="fa fa-folder-open" aria-hidden="true">&nbsp;</i><?php echo $org; ?></a></li>
                                            <li>
                                                <a href=""><i class="fa fa-folder-open" aria-hidden="true"></i><?php echo  $nama_kategori; ?></a></li>
                                            <li>
                                                <?php foreach ($data->result() as $key) { ?>
                                                    <a href=""><i class="fa fa-calendar" aria-hidden="true"></i>&nbsp;<?php echo format_indo(substr($key->tanggal_update, 0, 10)) ?></a></i> </li>
                                            <li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                    ...
                    <div class="side-bar">
                        ...
                        <div class="moduletable">
                            <div id="k2ModuleBox122" class="widget ">
                                ...
                                <ul class="level0">
                                    <li><?php echo $file_download; ?></span></li>
                                </ul>
                                <ul class="level0"><a href="<?php echo base_url('assets/file/' . $file_download . ''); ?>" class="btn btn-success"> <i class="fa fa-download"> &nbsp;</i>Download</a></span></li>
                                </ul>
                            </div>
                        </div>
