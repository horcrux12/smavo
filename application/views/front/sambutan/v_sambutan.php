        ...
        <div class="row">
            <div class="v-middle mt-30">
                <div class="text-center col-md-12">
                    <h5>Sambutan Kepala Sekolah SMAN 2 Cibinong</h5>
                    <div class="path">
...
<section id="team">
    <div class="container" style="padding-top: 20px;">
        <div class="section-header wow fadeInUp">
            ...
            <p>Berikut adalah sambutan bapak kepala SMAN 2 Cibinong guna menunjang kegiatan belajar mengajar agar terlaksana dengan baik dan nyaman</p>
        </div>
</section>
<!-- #team -->
