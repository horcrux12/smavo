                      ...
                      <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                        ...
                        <thead>
                          <tr>
                            ...
                            <th align="center">Id Mata Pelajaran</th>
                            <th align="center">Nama Mata Pelajaran</th>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td align="center">
                                ...
                                <a class="green" href="<?php echo base_url();?>kat_mapel/ubah/<?php echo $row->id_mapel?>" id="show-option2" title="Ubah" class="tooltip-info" data-rel="tooltip">
                           ...
                           <td align="center">
                                      ...
                                      <a class="red" href="<?php echo base_url();?>kat_mapel/delete/<?php echo $row->id_mapel?>"
