...
<input type="hidden" class="form-control" name="kode" id="kode" value="<?php echo $kode;?>">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
    <input type="text" class="form-control" name="jdl" id="jdl" value="<?php echo $jdl;?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" name="sub" id="sub" value="<?php echo $sub;?>">
    </div>
  </div>
  ...
  <div class="form-group">
    <label class="col-sm-2 control-label " for="isi">Isi slider</label>
    <div class="col-sm-8">
...
<!-- <script>
  $(document).ready(function() {
    ...
    if ($('#artikel').val() == "Non Akademik") {
        ...
        $.getJSON("<?php echo base_url(); ?>/slider/ambil_data_organisasi", function(data){
