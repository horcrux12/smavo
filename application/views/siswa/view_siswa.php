            ...
            <tr>
              ...
              <td class="center">
                <div class="hidden-sm hidden-xs action-buttons">
                  ...
                  <a class="red" href="<?php echo base_url(); ?>siswa/delete/<?php echo $row->id_artikel ?>" id="show-option1" title="Hapus" class="tooltip-info" data-rel="tooltip" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')">
