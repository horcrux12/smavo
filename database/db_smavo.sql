...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Feb 2020 pada 12.27
...
(180, '::1', '2020-02-22', 44, '', 'Chrome', '80.0.3987.116', 'DESKTOP-Q713SR9', 'Windows 10');
...
--
ALTER TABLE `tb_kontak`
  MODIFY `id_kontak` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
...
--
ALTER TABLE `tb_statistik`
  MODIFY `id_statistik` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=181;
--
