...
('ORG001', 'Osis', '', NULL, NULL),
('ORG002', 'MPK', '', NULL, NULL),
('ORG003', 'Pramuka', '', NULL, NULL),
...
('SW08022020003', 'KTS001', 'ORG013', 'USR001', 'PMR', '<p>PMRRRRRRR</p>', '2ProsesDanDataset.pdf', '2020-02-08 16:03:57'),
...
--
ALTER TABLE `tb_statistik`
  MODIFY `id_statistik` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;
--
